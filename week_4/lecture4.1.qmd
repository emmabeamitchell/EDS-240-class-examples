...
jobs_clean |> 
  ...
  geom_col() + # geom col has x and y variables 
...
jobs_clean |>
  ...
  geom_linerange(aes(ymin = 0, ymax = earnings_by_group), position = position_dodge(width = .5)) + 
  coord_flip() 
```
...
ggplot(subset_jobs) +
  ...
  scale_x_continuous(labels = label_currency(scale = .001, suffix = "k"),
