...
precip_data <- read_csv(here::here("week_5", "data", "NCEI-county-jan20-dec24-precip.csv"), 
                        skip = 4)
...
base_map <- ggplot(joined_precip_geom) +
  ...
  labs(
    title = "5-year precipitation compared to the 20th century average",
...
# save HEX codes as vector ----
my_brew_pal10 <- brewer.pal(n = 10, name = 'BrBG')
```
...
base_map +
  scale_fill_stepsn(colors = my_brew_pal10,
