...
github_icon <- "&#xf09b"
github_username <- "emmabeamitchell"
...
plot <- ggplot(subset_jobs) +
  ...
  scale_x_continuous(labels = scales::label_currency(scale = 0.001, suffix = "k"),
                     breaks = c(25000, 50000, 75000, 100000)) +
  labs(
    title = "Males earn more than females across occupations",
    subtitle = subtitle,
    caption = caption
  ) +
...
# write plot to file (aka save as png) ----
ggsave(
  filename = here::here("week_6", "images", "salary-plot-5x5.png"),
  plot = plot,
  device = "png",
  width = 5,
  height = 5,
